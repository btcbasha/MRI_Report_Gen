...
function Uploade() {
  ...
  const handleUpload = async () => {
    ...
    formData.append('message', 
      'Please summarize the "impression" section of a medical report, such as an MRI, in a way that is simple, memorable, and emotionally engaging for an adult with no medical background. Assume the person has only completed high school education and is unfamiliar with medical terminology. The goal is for them to understand the summary clearly while feeling reassured or empowered about their health. Your summary should: Be Emotionally Supportive: Use kind, empathetic language to provide comfort and hope. Use Relatable Analogies: Compare medical issues to everyday situations to make them easier to understand. Highlight Positive Actions or Next Steps: Offer a sense of control or optimism where appropriate. Be Easy to Remember: Use concise language or storytelling techniques to make the summary memorable. For example, if the report discusses a disc herniation in the spine, you could liken it to a cushion that’s been compressed but assure the patient that it’s a common condition with effective treatments available.');
    try {
